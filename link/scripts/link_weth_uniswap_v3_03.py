...
def decode_swap_event(data_hex):
    try:
        ...
        return weth_amount, link_amount, sqrtPriceX96, liquidity, tick, amount0, amount1
        ...
        for index, row in df.iterrows():
            try:
                ...
                if log_address and log_address != POOL_ADDRESS.lower():
                    continue
                weth_amount, link_amount, sqrtPriceX96, liquidity, tick, amount0_raw, amount1_raw = decode_swap_event(row['data'])
