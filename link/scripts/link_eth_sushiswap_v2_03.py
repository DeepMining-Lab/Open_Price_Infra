...
POOL_ADDRESS    = Web3.to_checksum_address("0xc40d16476380e4037e6b1a2594caf6a6cc8da967")
...
def get_all_metrics(web3, bn, price_ref):
    ...
    try:
        r0, r1 = get_reserves(web3, bn)  # r0=LINK, r1=WETH

        bal0 = mp.mpf(r0) / 10**TOKEN0_DECIMALS  # LINK
        bal1 = mp.mpf(r1) / 10**TOKEN1_DECIMALS  # WETH
        tvl = float(bal1 + bal0 * price_ref)      # TVL en ETH

        # slip_1k: 1 ETH → LINK (tokenIn=WETH=token1, tokenOut=LINK=token0)
