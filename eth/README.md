...
|----------------------------------|---------------------------------|-----------------------------------------------|
| **Chainlink ETH/USD**         | 2026-06-19 16:56:47 UTC      | `data/chainlink_eth_usd.csv`                  |
| **Uniswap V3 ETH/USDC**      | 2026-06-19 17:29:23 UTC        | `data/eth_usdc_uniswap_v3_005.csv`            |
| **Uniswap V2 WETH/USDC**     | 2026-06-19 17:25:35 UTC   | `data/weth_usdc_uniswap_v2_03.csv`            |
| **Uniswap V2 WETH/USDT**     | 2026-06-19 17:17:23 UTC   | `data/weth_usdt_uniswap_v2_03.csv`            |
