...
|----------------------------------|---------------------------------|-----------------------------------------------|
| **Chainlink ETH/USD**         | 2026-09-05 10:02:23 UTC      | `data/chainlink_eth_usd.csv`                  |
| **Uniswap V3 ETH/USDC**      | 2026-09-05 10:02:11 UTC        | `data/eth_usdc_uniswap_v3_005.csv`            |
| **Uniswap V2 WETH/USDC**     | 2026-09-05 09:59:59 UTC   | `data/weth_usdc_uniswap_v2_03.csv`            |
| **Uniswap V2 WETH/USDT**     | 2026-09-05 10:08:47 UTC   | `data/weth_usdt_uniswap_v2_03.csv`            |
