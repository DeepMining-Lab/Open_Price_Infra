...
| **Uniswap V3 AAVE/USDT**     | {{ usdt.extraction }}           | `data/aave_usdt_uniswap_v3_03.csv`           |
| **Uniswap V3 AAVE/WETH**     | {{ weth_v3.extraction }}        | `data/aave_weth_uniswap_v3_03.csv`           |
| **SushiSwap V2 AAVE/ETH**    | {{ sushi_v2.extraction }}       | `data/aave_eth_sushiswap_v2_03.csv`          |
