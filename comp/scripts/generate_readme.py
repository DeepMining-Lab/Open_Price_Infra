...
data_info = {
    "chainlink": {
        "path": TEMPLATE_DIR.parent / "data" / "chainlink_comp_usd.csv",
        "col_name": "datetime_utc",
        "fmt": "%Y-%m-%d %H:%M:%S%z",
        "tz_aware": True,
    },
    "uniswap": {
        "path": TEMPLATE_DIR.parent / "data" / "comp_usdc_uniswap_v3_03.csv",
        "col_name": "timestamp",
        "fmt": "%Y-%m-%d %H:%M:%S%z",
        "tz_aware": True,
    },
    "usdt": {
        "path": TEMPLATE_DIR.parent / "data" / "comp_usdt_uniswap_v3_03.csv",
        "col_name": "timestamp",
        "fmt": "%Y-%m-%d %H:%M:%S%z",
        "tz_aware": True,
    },
    "weth_v3": {
        "path": TEMPLATE_DIR.parent / "data" / "comp_weth_uniswap_v3_03.csv",
        "col_name": "timestamp",
        "fmt": "%Y-%m-%d %H:%M:%S%z",
        "tz_aware": True,
    },
    "weth_v2": {
        "path": TEMPLATE_DIR.parent / "data" / "comp_weth_uniswap_v2_03.csv",
        "col_name": "timestamp",
        "fmt": "%Y-%m-%d %H:%M:%S%z",
        "tz_aware": True,
    },
    "sushi_v2": {
        "path": TEMPLATE_DIR.parent / "data" / "comp_eth_sushiswap_v2_03.csv",
        "col_name": "timestamp",
        "fmt": "%Y-%m-%d %H:%M:%S%z",
        "tz_aware": True,
    },
