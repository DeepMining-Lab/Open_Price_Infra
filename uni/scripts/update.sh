...
DATA_FILE_UNISWAP="$PROJECT_DIR/data/uni_usdc_uniswap_v3_03.csv"
DATA_FILE_CHAINLINK="$PROJECT_DIR/data/chainlink_uni_usd.csv"
OUTPUT_DIR="$PROJECT_DIR/data/output"
LAST_FILE_UNISWAP="$PROJECT_DIR/data/uni_usdc_uniswap_v3_03_last.csv"
...
for i in $(seq 1 $MAX); do
  ...
  if scp data/{chainlink_uni_usd.csv,uni_usdc_uniswap_v3_03.csv,uni_usdt_uniswap_v3_03.csv,uni_weth_uniswap_v3_03.csv,uni_weth_uniswap_v2_03.csv,uni_eth_sushiswap_v3_03.csv} debian@extract.lan.text-analytics.ch:/data/ethereum/prices; then
    SCP_OK=true
    break
  fi
